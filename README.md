...
📌 [**BazarLTD: An e-commerce website**](https://baarltd22.surge.sh/) ([GitHub](https://github.com/Md-Sifat-code/BazarLTD))

📌 [**TenmanBD website: An ERP system**](https://tenmanbd.com/) ([GitHub](https://github.com/hrid0yyy/tenmanbd))
